...
class KlassifisertInntektMånedTest {
    ...
    fun `all combines three inntektsperioder correctly`() {
        assertEquals(emptyList<KlassifisertInntektMåned>(), Triple(emptyList<KlassifisertInntektMåned>(), emptyList<KlassifisertInntektMåned>(), emptyList<KlassifisertInntektMåned>()).all())
